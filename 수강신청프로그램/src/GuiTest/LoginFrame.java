...
public class LoginFrame extends JFrame {
	...
	protected static final String ManagementDAO = null;
	//불러오는고~!
	...
	public LoginFrame() {
		...
		lId = new JLabel("아이디");
		lId.setFont(new Font("돋움", Font.BOLD, 15));
		...
		lPassword.setFont(new Font("돋움", Font.BOLD, 15));
